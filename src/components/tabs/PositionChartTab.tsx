...
const PositionChartTab = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className={isMobile ? "w-full overflow-x-auto" : "w-full"} style={{ height: 500 }}>
        <div style={{ width: isMobile ? 900 : '100%', height: '100%' }}>
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 10 }}>
              <XAxis dataKey="lap" type="number" domain={[1, maxLap]} tick={{ fill: '#5a7a94', fontSize: 11, fontFamily: 'DM Mono' }} tickCount={10} />
              <YAxis reversed domain={[1, 25]} tick={{ fill: '#5a7a94', fontSize: 11, fontFamily: 'DM Mono' }} tickCount={13} />
