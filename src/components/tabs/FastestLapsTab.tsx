...
const FastestLapsTab = () => {
  ...
  // Qualifying sector comparison data
  ...
  // Find best sector times across all drivers
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Qualifying Sector Comparison - only shown when Qualifying selected */}
                ...
                <table className="w-full min-w-[600px] text-left">
                  ...
                  <tbody>
                    {SECTOR_KEYS.map(sk => {
                      ...
                      // Negative delta = Lap 2 faster (green), Positive = Lap 1 faster (red)
                      return (
